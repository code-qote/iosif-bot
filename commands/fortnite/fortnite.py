...
class Fortnite(commands.Cog):
    def __init__(self, bot):
        ...
        # self.check_store_update = self.bot.loop.create_task(check_update_task())
        # asyncio.gather(self.check_store_update)
            ...
            for stat in stats.keys():
                if k < 3:
                    if stat != 'ltm':
                        ...
                        await ctx.send(embed=self.get_embed(stats_type, nickname, picture, wins, kd,
